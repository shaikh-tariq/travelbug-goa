      ...
      {[
        {
          ...
          slug: "service-1",
          desc: "Explore the hidden gems, heritage churches, and pristine beaches of North and South Goa.",
          image: "https://images.unsplash.com/photo-1501504905252-473c47e087f8?auto=format&fit=crop&w=600&q=80"
        },
        {
          title: "Boat Cruises",
          slug: "service-2",
          desc: "Unforgettable Mandovi river sunset cruises and luxury yacht charters for special occasions.",
          image: "https://images.unsplash.com/photo-1510414842594-a61c69b5ae57?auto=format&fit=crop&w=600&q=80"
        },
        {
          title: "Watersports",
          slug: "service-3",
          desc: "Thrilling parasailing, jet skiing, and scuba diving packages across Goan beaches.",
          image: "https://images.unsplash.com/photo-1511895426328-dc8714191300?auto=format&fit=crop&w=600&q=80"
        },
        {
          title: "Event Management",
          slug: "service-4",
          desc: "Comprehensive corporate travel (MICE), destination weddings, and group party coordination.",
      ...
      >
        <section className="py-24 px-6 text-center max-w-4xl mx-auto relative">
          ...
          <p className="text-lg text-ink/70 leading-relaxed font-medium">
            Welcome to TravelBug Goa, your local Goan travel expert. We curate the best Goa sightseeing tours, sunset boat cruises, thrilling watersports, and custom corporate event management in Goa.
          </p>
          <div className="mt-12">
